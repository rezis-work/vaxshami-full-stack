...
const Gallery = () => {
  return (
    <section className="my-8 bg-[#03071E] text-white">
      <Wrapper className="relative grid grid-cols-1 lg:grid-cols-7 xl:grid-cols-3 gap-4  pt-30 pb-16 mx-auto">
        ...
        <div className="rounded-sm borderGradient p-1 lg:col-span-3 xl:col-span-1">
          <ul className="h-full flex flex-col gap-4 rounded-sm bg-black px-6 py-4">
