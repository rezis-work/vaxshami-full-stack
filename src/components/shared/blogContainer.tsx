...
export default function BlogCardContainer({
  ...
  return (
    <div className="mx-auto px-[15px] lg:px-0 xl:px-[-15px] xl:mx-0 2xl:px-[15px]]">
      ...
      <div
        className={cn(
          "mb-[30px]  grid grid-cols-1 justify-center 2xl:w-[824px] xl:w-[730px] lg:w-[610px] md:w-[690px] sm:w-[510px] max-sm:max-w-[530px] max-sm:w-full [&>*]:h-auto gap-x-[30px] gap-y-[30px]",
          className
        )}
      >
        {children}
